...
type
  ...
  TCAST128Key =  array[0..15] of byte;
  PCAST128Key = ^TCAST128Key;
  TCAST128ExpandedKey = array[0..31] of cardinal;
  TCAST128Buffer =  array[0..7] of byte;
  PCAST128Buffer = ^TCAST128Buffer;
  PLongWord = ^cardinal;


{ Block processing routines }
procedure ExpandKey(const Key:  TCAST128Key ; out ExpandedKey: TCAST128ExpandedKey); 
procedure Encrypt16(var B0, B1 : cardinal; var ExpandedKey : TCast128ExpandedKey); 
procedure Decrypt16(var B0, B1 : cardinal; var ExpandedKey : TCast128ExpandedKey); 

implementation

const
  S1: array[0..255] of cardinal = 
     ( 
...
var
  ...
  x0x1x2x3, x4x5x6x7, x8x9xAxB, xCxDxExF, z0z1z2z3, z4z5z6z7, z8z9zAzB, zCzDzEzF : ^cardinal;
  x0, x1, x2, x3, x4, x5, x6, x7, x8, x9, xA, xB, xC, xD, xE, xF : ^byte;
  z0, z1, z2, z3, z4, z5, z6, z7, z8, z9, zA, zB, zC, zD, zE, zF : ^byte;
begin
  x0x1x2x3 := @Buf[0]; x4x5x6x7 := @Buf[1]; x8x9xAxB := @Buf[2]; xCxDxExF := @Buf[3];
  z0z1z2z3 := @Buf[4]; z4z5z6z7 := @Buf[5]; z8z9zAzB := @Buf[6]; zCzDzEzF := @Buf[7];
  x0 := @PByteArray(@Buf[0])[3];
  x1 := @PByteArray(@Buf[0])[2];
  x2 := @PByteArray(@Buf[0])[1];
  x3 := @PByteArray(@Buf[0])[0];
  x4 := @PByteArray(@Buf[1])[3];
  x5 := @PByteArray(@Buf[1])[2];
  x6 := @PByteArray(@Buf[1])[1];
  x7 := @PByteArray(@Buf[1])[0];
  x8 := @PByteArray(@Buf[2])[3];
  x9 := @PByteArray(@Buf[2])[2];
  xA := @PByteArray(@Buf[2])[1];
  xB := @PByteArray(@Buf[2])[0];
  xC := @PByteArray(@Buf[3])[3];
  xD := @PByteArray(@Buf[3])[2];
  xE := @PByteArray(@Buf[3])[1];
  xF := @PByteArray(@Buf[3])[0];
  z0 := @PByteArray(@Buf[4])[3];
  z1 := @PByteArray(@Buf[4])[2];
  z2 := @PByteArray(@Buf[4])[1];
  z3 := @PByteArray(@Buf[4])[0];
  z4 := @PByteArray(@Buf[5])[3];
  z5 := @PByteArray(@Buf[5])[2];
  z6 := @PByteArray(@Buf[5])[1];
  z7 := @PByteArray(@Buf[5])[0];
  z8 := @PByteArray(@Buf[6])[3];
  z9 := @PByteArray(@Buf[6])[2];
  zA := @PByteArray(@Buf[6])[1];
  zB := @PByteArray(@Buf[6])[0];
  zC := @PByteArray(@Buf[7])[3];
  zD := @PByteArray(@Buf[7])[2];
  zE := @PByteArray(@Buf[7])[1];
  zF := @PByteArray(@Buf[7])[0];
  Buf[0] := (Key[0] shl 24) or (Key[1] shl 16) or (Key[2] shl 8) or Key[3];
  Buf[1] := (Key[4] shl 24) or (Key[5] shl 16) or (Key[6] shl 8) or Key[7];
  Buf[2] := (Key[8] shl 24) or (Key[9] shl 16) or (Key[10] shl 8) or Key[11];
  Buf[3] := (Key[12] shl 24) or (Key[13] shl 16) or (Key[14] shl 8) or Key[15];
  ...
  ExpandedKey[0] := S5[z8^] xor S6[z9^] xor S7[z7^] xor S8[z6^] xor S5[z2^];
  ExpandedKey[1] := S5[zA^] xor S6[zB^] xor S7[z5^] xor S8[z4^] xor S6[z6^];
  ExpandedKey[2]  := S5[zC^] xor S6[zD^] xor S7[z3^] xor S8[z2^] xor S7[z9^];
  ExpandedKey[3]  := S5[zE^] xor S6[zF^] xor S7[z1^] xor S8[z0^] xor S8[zC^];
  ...
  ExpandedKey[4]  := S5[x3^] xor S6[x2^] xor S7[xC^] xor S8[xD^] xor S5[x8^];
  ExpandedKey[5]  := S5[x1^] xor S6[x0^] xor S7[xE^] xor S8[xF^] xor S6[xD^];
  ExpandedKey[6]  := S5[x7^] xor S6[x6^] xor S7[x8^] xor S8[x9^] xor S7[x3^];
  ExpandedKey[7]  := S5[x5^] xor S6[x4^] xor S7[xA^] xor S8[xB^] xor S8[x7^];
  z0z1z2z3^ := x0x1x2x3^ xor S5[xD^] xor S6[xF^] xor S7[xC^] xor S8[xE^] xor S7[x8^];
  z4z5z6z7^ := x8x9xAxB^ xor S5[z0^] xor S6[z2^] xor S7[z1^] xor S8[z3^] xor S8[xA^];
  z8z9zAzB^ := xCxDxExF^ xor S5[z7^] xor S6[z6^] xor S7[z5^] xor S8[z4^] xor S5[x9^];
  zCzDzEzF^ := x4x5x6x7^ xor S5[zA^] xor S6[z9^] xor S7[zB^] xor S8[z8^] xor S6[xB^];
  ExpandedKey[8]  := S5[z3^] xor S6[z2^] xor S7[zC^] xor S8[zD^] xor S5[z9^];
  ExpandedKey[9]  := S5[z1^] xor S6[z0^] xor S7[zE^] xor S8[zF^] xor S6[zC^];
  ExpandedKey[10] := S5[z7^] xor S6[z6^] xor S7[z8^] xor S8[z9^] xor S7[z2^];
  ExpandedKey[11] := S5[z5^] xor S6[z4^] xor S7[zA^] xor S8[zB^] xor S8[z6^];
  x0x1x2x3^ := z8z9zAzB^ xor S5[z5^] xor S6[z7^] xor S7[z4^] xor S8[z6^] xor S7[z0^];
  x4x5x6x7^ := z0z1z2z3^ xor S5[x0^] xor S6[x2^] xor S7[x1^] xor S8[x3^] xor S8[z2^];
  x8x9xAxB^ := z4z5z6z7^ xor S5[x7^] xor S6[x6^] xor S7[x5^] xor S8[x4^] xor S5[z1^];
  xCxDxExF^ := zCzDzEzF^ xor S5[xA^] xor S6[x9^] xor S7[xB^] xor S8[x8^] xor S6[z3^];
  ExpandedKey[12] := S5[x8^] xor S6[x9^] xor S7[x7^] xor S8[x6^] xor S5[x3^];
  ExpandedKey[13] := S5[xA^] xor S6[xB^] xor S7[x5^] xor S8[x4^] xor S6[x7^];
  ExpandedKey[14] := S5[xC^] xor S6[xD^] xor S7[x3^] xor S8[x2^] xor S7[x8^];
  ExpandedKey[15] := S5[xE^] xor S6[xF^] xor S7[x1^] xor S8[x0^] xor S8[xD^];
  z0z1z2z3^ := x0x1x2x3^ xor S5[xD^] xor S6[xF^] xor S7[xC^] xor S8[xE^] xor S7[x8^];
  z4z5z6z7^ := x8x9xAxB^ xor S5[z0^] xor S6[z2^] xor S7[z1^] xor S8[z3^] xor S8[xA^];
  z8z9zAzB^ := xCxDxExF^ xor S5[z7^] xor S6[z6^] xor S7[z5^] xor S8[z4^] xor S5[x9^];
  zCzDzEzF^ := x4x5x6x7^ xor S5[zA^] xor S6[z9^] xor S7[zB^] xor S8[z8^] xor S6[xB^];
  ExpandedKey[16] := (S5[z8^] xor S6[z9^] xor S7[z7^] xor S8[z6^] xor S5[z2^]) and $1f;
  ExpandedKey[17] := (S5[zA^] xor S6[zB^] xor S7[z5^] xor S8[z4^] xor S6[z6^]) and $1f;
  ExpandedKey[18] := (S5[zC^] xor S6[zD^] xor S7[z3^] xor S8[z2^] xor S7[z9^]) and $1f;
  ExpandedKey[19] := (S5[zE^] xor S6[zF^] xor S7[z1^] xor S8[z0^] xor S8[zC^]) and $1f;
  x0x1x2x3^ := z8z9zAzB^ xor S5[z5^] xor S6[z7^] xor S7[z4^] xor S8[z6^] xor S7[z0^];
  x4x5x6x7^ := z0z1z2z3^ xor S5[x0^] xor S6[x2^] xor S7[x1^] xor S8[x3^] xor S8[z2^];
  x8x9xAxB^ := z4z5z6z7^ xor S5[x7^] xor S6[x6^] xor S7[x5^] xor S8[x4^] xor S5[z1^];
  xCxDxExF^ := zCzDzEzF^ xor S5[xA^] xor S6[x9^] xor S7[xB^] xor S8[x8^] xor S6[z3^];
  ExpandedKey[20] := (S5[x3^] xor S6[x2^] xor S7[xC^] xor S8[xD^] xor S5[x8^]) and $1f;
  ExpandedKey[21] := (S5[x1^] xor S6[x0^] xor S7[xE^] xor S8[xF^] xor S6[xD^]) and $1f;
  ExpandedKey[22] := (S5[x7^] xor S6[x6^] xor S7[x8^] xor S8[x9^] xor S7[x3^]) and $1f;
  ExpandedKey[23] := (S5[x5^] xor S6[x4^] xor S7[xA^] xor S8[xB^] xor S8[x7^]) and $1f;
  z0z1z2z3^ := x0x1x2x3^ xor S5[xD^] xor S6[xF^] xor S7[xC^] xor S8[xE^] xor S7[x8^];
  z4z5z6z7^ := x8x9xAxB^ xor S5[z0^] xor S6[z2^] xor S7[z1^] xor S8[z3^] xor S8[xA^];
  z8z9zAzB^ := xCxDxExF^ xor S5[z7^] xor S6[z6^] xor S7[z5^] xor S8[z4^] xor S5[x9^];
  zCzDzEzF^ := x4x5x6x7^ xor S5[zA^] xor S6[z9^] xor S7[zB^] xor S8[z8^] xor S6[xB^];
  ExpandedKey[24] := (S5[z3^] xor S6[z2^] xor S7[zC^] xor S8[zD^] xor S5[z9^]) and $1f;
  ExpandedKey[25] := (S5[z1^] xor S6[z0^] xor S7[zE^] xor S8[zF^] xor S6[zC^]) and $1f;
  ExpandedKey[26] := (S5[z7^] xor S6[z6^] xor S7[z8^] xor S8[z9^] xor S7[z2^]) and $1f;
  ExpandedKey[27] := (S5[z5^] xor S6[z4^] xor S7[zA^] xor S8[zB^] xor S8[z6^]) and $1f;
  x0x1x2x3^ := z8z9zAzB^ xor S5[z5^] xor S6[z7^] xor S7[z4^] xor S8[z6^] xor S7[z0^];
  x4x5x6x7^ := z0z1z2z3^ xor S5[x0^] xor S6[x2^] xor S7[x1^] xor S8[x3^] xor S8[z2^];
  x8x9xAxB^ := z4z5z6z7^ xor S5[x7^] xor S6[x6^] xor S7[x5^] xor S8[x4^] xor S5[z1^];
  xCxDxExF^ := zCzDzEzF^ xor S5[xA^] xor S6[x9^] xor S7[xB^] xor S8[x8^] xor S6[z3^];
  ExpandedKey[28] := (S5[x8^] xor S6[x9^] xor S7[x7^] xor S8[x6^] xor S5[x3^]) and $1f;
  ExpandedKey[29] := (S5[xA^] xor S6[xB^] xor S7[x5^] xor S8[x4^] xor S6[x7^]) and $1f;
  ExpandedKey[30] := (S5[xC^] xor S6[xD^] xor S7[x3^] xor S8[x2^] xor S7[x8^]) and $1f;
  ExpandedKey[31] := (S5[xE^] xor S6[xF^] xor S7[x1^] xor S8[x0^] xor S8[xD^]) and $1f;
end;

procedure CAST128Type1( var  Rc : cardinal; D, Km, Kr: cardinal);
var
  X : cardinal;
begin
  X := Km + D;
  X := (X shl Kr) or (X shr (32 - Kr));
  Rc := S1[PByteArray(@X)[3]] xor S2[PByteArray(@X)[2]] - S3[PByteArray(@X)[1]] + S4[PByteArray(@X)[0]];
end;

procedure CAST128Type2( var  Rc : cardinal; D, Km, Kr: cardinal);
var
  X : cardinal;
begin
  X := Km xor D;
  X := (X shl Kr) or (X shr (32 - Kr));
  Rc := S1[PByteArray(@X)[3]] - S2[PByteArray(@X)[2]] + S3[PByteArray(@X)[1]] xor S4[PByteArray(@X)[0]];
end;

procedure CAST128Type3( var  Rc : cardinal; D, Km, Kr: cardinal);
var
  X : cardinal;
begin
  X := Km - D;
  X := (X shl Kr) or (X shr (32 - Kr));
  Rc := S1[PByteArray(@X)[3]] + S2[PByteArray(@X)[2]] xor S3[PByteArray(@X)[1]] - S4[PByteArray(@X)[0]];
end;
...
var
  ...
  Km, Kr : ^cardinal;
begin
  { current CAST128 implementation works in big-endian mode, while in cryptoproviders we use little-endian }
  ...
  Km := @ExpandedKey[0];
  Kr := @ExpandedKey[16];
  Br := R; CAST128Type1(Rc, R, Km^, Kr^); R := L xor Rc; L := Br; Inc(Km); Inc(Kr);
  Br := R; CAST128Type2(Rc, R, Km^, Kr^); R := L xor Rc; L := Br; Inc(Km); Inc(Kr);
  Br := R; CAST128Type3(Rc, R, Km^, Kr^); R := L xor Rc; L := Br; Inc(Km); Inc(Kr);
  Br := R; CAST128Type1(Rc, R, Km^, Kr^); R := L xor Rc; L := Br; Inc(Km); Inc(Kr);
  Br := R; CAST128Type2(Rc, R, Km^, Kr^); R := L xor Rc; L := Br; Inc(Km); Inc(Kr);
  Br := R; CAST128Type3(Rc, R, Km^, Kr^); R := L xor Rc; L := Br; Inc(Km); Inc(Kr);
  Br := R; CAST128Type1(Rc, R, Km^, Kr^); R := L xor Rc; L := Br; Inc(Km); Inc(Kr);
  ...
  Br := R; CAST128Type2(Rc, R, Km^, Kr^); R := L xor Rc; L := Br; Inc(Km); Inc(Kr);
  Br := R; CAST128Type3(Rc, R, Km^, Kr^); R := L xor Rc; L := Br; Inc(Km); Inc(Kr);
  Br := R; CAST128Type1(Rc, R, Km^, Kr^); R := L xor Rc; L := Br;
...
begin
  { current CAST128 implementation works in big-endian mode, while in cryptoproviders we use little-endian }
  { consider rewriting Blowfish to remove this code overhead }
  R := (B0 shr 24) or ((B0 shr 8) and $ff00) or ((B0 shl 8) and $ff0000) or (B0 shl 24);
  L := (B1 shr 24) or ((B1 shr 8) and $ff00) or ((B1 shl 8) and $ff0000) or (B1 shl 24);
  
  Km := @ExpandedKey[15];
  Kr := @ExpandedKey[31];
  Bl := L; CAST128Type1(Rc, L, Km^, Kr^); L := R xor Rc; R := Bl; Dec(Km); Dec(Kr);
  Bl := L; CAST128Type3(Rc, L, Km^, Kr^); L := R xor Rc; R := Bl; Dec(Km); Dec(Kr);
  Bl := L; CAST128Type2(Rc, L, Km^, Kr^); L := R xor Rc; R := Bl; Dec(Km); Dec(Kr);
  Bl := L; CAST128Type1(Rc, L, Km^, Kr^); L := R xor Rc; R := Bl; Dec(Km); Dec(Kr);
  Bl := L; CAST128Type3(Rc, L, Km^, Kr^); L := R xor Rc; R := Bl; Dec(Km); Dec(Kr);
  Bl := L; CAST128Type2(Rc, L, Km^, Kr^); L := R xor Rc; R := Bl; Dec(Km); Dec(Kr);
  Bl := L; CAST128Type1(Rc, L, Km^, Kr^); L := R xor Rc; R := Bl; Dec(Km); Dec(Kr);
  ...
  Bl := L; CAST128Type3(Rc, L, Km^, Kr^); L := R xor Rc; R := Bl; Dec(Km); Dec(Kr);
  Bl := L; CAST128Type2(Rc, L, Km^, Kr^); L := R xor Rc; R := Bl; Dec(Km); Dec(Kr);
  Bl := L; CAST128Type1(Rc, L, Km^, Kr^); L := R xor Rc; R := Bl;
