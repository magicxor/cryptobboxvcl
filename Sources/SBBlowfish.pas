...
type
  ...
  TSBBlowfishContext =  record
    P0, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, P15, P16, P17 : cardinal;
    S0 : array  [0..255]  of cardinal;
...
procedure EncryptBlock(var Context : TSBBlowfishContext; var L, R : cardinal); 
procedure DecryptBlock(var Context : TSBBlowfishContext; var L, R : cardinal); 
procedure Initialize(var Context : TSBBlowfishContext; const Key : ByteArray); 

{ BCrypt 'expensive key schedule' }
procedure EksInitialize(var Context : TSBBlowfishContext; Rounds : integer; const Salt, Key : ByteArray); 
...
const
  ...
  ORIG_S : array[0..3, 0..255] of cardinal = 
     ( 
     ( 
...
procedure EncryptBlock(var Context : TSBBlowfishContext; var L, R : cardinal);
var
  L_, R_ : cardinal; // local variables are accessed much faster
begin
  { Iteration 0 }
  L_ := L xor Context.P0;
  R_ := R xor ((Context.S0[L_ shr 24] + Context.S1[(L_ shr 16) and $FF]) xor
    Context.S2[(L_ shr 8) and $FF] + Context.S3[L_ and $FF]);
  { Iteration 1 }
  R_ := R_ xor Context.P1;
  L_ := L_ xor ((Context.S0[R_ shr 24] + Context.S1[(R_ shr 16) and $FF]) xor
    Context.S2[(R_ shr 8) and $FF] + Context.S3[R_ and $FF]);
  { Iteration 2 }
  L_ := L_ xor Context.P2;
  R_ := R_ xor ((Context.S0[L_ shr 24] + Context.S1[(L_ shr 16) and $FF]) xor
    Context.S2[(L_ shr 8) and $FF] + Context.S3[L_ and $FF]);
  { Iteration 3 }
  R_ := R_ xor Context.P3;
  L_ := L_ xor ((Context.S0[R_ shr 24] + Context.S1[(R_ shr 16) and $FF]) xor
    Context.S2[(R_ shr 8) and $FF] + Context.S3[R_ and $FF]);
  { Iteration 4 }
  L_ := L_ xor Context.P4;
  R_ := R_ xor ((Context.S0[L_ shr 24] + Context.S1[(L_ shr 16) and $FF]) xor
    Context.S2[(L_ shr 8) and $FF] + Context.S3[L_ and $FF]);
  { Iteration 5 }
  R_ := R_ xor Context.P5;
  L_ := L_ xor ((Context.S0[R_ shr 24] + Context.S1[(R_ shr 16) and $FF]) xor
    Context.S2[(R_ shr 8) and $FF] + Context.S3[R_ and $FF]);
  { Iteration 6 }
  L_ := L_ xor Context.P6;
  R_ := R_ xor ((Context.S0[L_ shr 24] + Context.S1[(L_ shr 16) and $FF]) xor
    Context.S2[(L_ shr 8) and $FF] + Context.S3[L_ and $FF]);
  { Iteration 7 }
  R_ := R_ xor Context.P7;
  L_ := L_ xor ((Context.S0[R_ shr 24] + Context.S1[(R_ shr 16) and $FF]) xor
    Context.S2[(R_ shr 8) and $FF] + Context.S3[R_ and $FF]);
  { Iteration 8 }
  L_ := L_ xor Context.P8;
  R_ := R_ xor ((Context.S0[L_ shr 24] + Context.S1[(L_ shr 16) and $FF]) xor
    Context.S2[(L_ shr 8) and $FF] + Context.S3[L_ and $FF]);
  { Iteration 9 }
  R_ := R_ xor Context.P9;
  L_ := L_ xor ((Context.S0[R_ shr 24] + Context.S1[(R_ shr 16) and $FF]) xor
    Context.S2[(R_ shr 8) and $FF] + Context.S3[R_ and $FF]);
  { Iteration 10 }
  L_ := L_ xor Context.P10;
  R_ := R_ xor ((Context.S0[L_ shr 24] + Context.S1[(L_ shr 16) and $FF]) xor
    Context.S2[(L_ shr 8) and $FF] + Context.S3[L_ and $FF]);
  { Iteration 11 }
  R_ := R_ xor Context.P11;
  L_ := L_ xor ((Context.S0[R_ shr 24] + Context.S1[(R_ shr 16) and $FF]) xor
    Context.S2[(R_ shr 8) and $FF] + Context.S3[R_ and $FF]);
  { Iteration 12 }
  L_ := L_ xor Context.P12;
  R_ := R_ xor ((Context.S0[L_ shr 24] + Context.S1[(L_ shr 16) and $FF]) xor
    Context.S2[(L_ shr 8) and $FF] + Context.S3[L_ and $FF]);
  { Iteration 13 }
  R_ := R_ xor Context.P13;
  L_ := L_ xor ((Context.S0[R_ shr 24] + Context.S1[(R_ shr 16) and $FF]) xor
    Context.S2[(R_ shr 8) and $FF] + Context.S3[R_ and $FF]);
  { Iteration 14 }
  L_ := L_ xor Context.P14;
  R_ := R_ xor ((Context.S0[L_ shr 24] + Context.S1[(L_ shr 16) and $FF]) xor
    Context.S2[(L_ shr 8) and $FF] + Context.S3[L_ and $FF]);
  { Iteration 15 }
  R_ := R_ xor Context.P15;
  L_ := L_ xor ((Context.S0[R_ shr 24] + Context.S1[(R_ shr 16) and $FF]) xor
    Context.S2[(R_ shr 8) and $FF] + Context.S3[R_ and $FF]);

  R := L_ xor Context.P16;
  L := R_ xor Context.P17;
end;
...
begin
  { Iteration 0 }
  L_ := L xor Context.P17;
  R_ := R xor ((Context.S0[L_ shr 24] + Context.S1[(L_ shr 16) and $FF]) xor
    Context.S2[(L_ shr 8) and $FF] + Context.S3[L_ and $FF]);
  { Iteration 1 }
  R_ := R_ xor Context.P16;
  L_ := L_ xor ((Context.S0[R_ shr 24] + Context.S1[(R_ shr 16) and $FF]) xor
    Context.S2[(R_ shr 8) and $FF] + Context.S3[R_ and $FF]);
  { Iteration 2 }
  L_ := L_ xor Context.P15;
  R_ := R_ xor ((Context.S0[L_ shr 24] + Context.S1[(L_ shr 16) and $FF]) xor
    Context.S2[(L_ shr 8) and $FF] + Context.S3[L_ and $FF]);
  { Iteration 3 }
  R_ := R_ xor Context.P14;
  L_ := L_ xor ((Context.S0[R_ shr 24] + Context.S1[(R_ shr 16) and $FF]) xor
    Context.S2[(R_ shr 8) and $FF] + Context.S3[R_ and $FF]);
  { Iteration 4 }
  L_ := L_ xor Context.P13;
  R_ := R_ xor ((Context.S0[L_ shr 24] + Context.S1[(L_ shr 16) and $FF]) xor
    Context.S2[(L_ shr 8) and $FF] + Context.S3[L_ and $FF]);
  { Iteration 5 }
  R_ := R_ xor Context.P12;
  L_ := L_ xor ((Context.S0[R_ shr 24] + Context.S1[(R_ shr 16) and $FF]) xor
    Context.S2[(R_ shr 8) and $FF] + Context.S3[R_ and $FF]);
  { Iteration 6 }
  L_ := L_ xor Context.P11;
  R_ := R_ xor ((Context.S0[L_ shr 24] + Context.S1[(L_ shr 16) and $FF]) xor
    Context.S2[(L_ shr 8) and $FF] + Context.S3[L_ and $FF]);
  { Iteration 7 }
  R_ := R_ xor Context.P10;
  L_ := L_ xor ((Context.S0[R_ shr 24] + Context.S1[(R_ shr 16) and $FF]) xor
    Context.S2[(R_ shr 8) and $FF] + Context.S3[R_ and $FF]);
  { Iteration 8 }
  L_ := L_ xor Context.P9;
  R_ := R_ xor ((Context.S0[L_ shr 24] + Context.S1[(L_ shr 16) and $FF]) xor
    Context.S2[(L_ shr 8) and $FF] + Context.S3[L_ and $FF]);
  { Iteration 9 }
  R_ := R_ xor Context.P8;
  L_ := L_ xor ((Context.S0[R_ shr 24] + Context.S1[(R_ shr 16) and $FF]) xor
    Context.S2[(R_ shr 8) and $FF] + Context.S3[R_ and $FF]);
  { Iteration 10 }
  L_ := L_ xor Context.P7;
  R_ := R_ xor ((Context.S0[L_ shr 24] + Context.S1[(L_ shr 16) and $FF]) xor
    Context.S2[(L_ shr 8) and $FF] + Context.S3[L_ and $FF]);
  { Iteration 11 }
  R_ := R_ xor Context.P6;
  L_ := L_ xor ((Context.S0[R_ shr 24] + Context.S1[(R_ shr 16) and $FF]) xor
    Context.S2[(R_ shr 8) and $FF] + Context.S3[R_ and $FF]);
  { Iteration 12 }
  L_ := L_ xor Context.P5;
  R_ := R_ xor ((Context.S0[L_ shr 24] + Context.S1[(L_ shr 16) and $FF]) xor
    Context.S2[(L_ shr 8) and $FF] + Context.S3[L_ and $FF]);
  { Iteration 13 }
  R_ := R_ xor Context.P4;
  L_ := L_ xor ((Context.S0[R_ shr 24] + Context.S1[(R_ shr 16) and $FF]) xor
    Context.S2[(R_ shr 8) and $FF] + Context.S3[R_ and $FF]);
  { Iteration 14 }
  L_ := L_ xor Context.P3;
  R_ := R_ xor ((Context.S0[L_ shr 24] + Context.S1[(L_ shr 16) and $FF]) xor
    Context.S2[(L_ shr 8) and $FF] + Context.S3[L_ and $FF]);
  { Iteration 15 }
  R_ := R_ xor Context.P2;
  L_ := L_ xor ((Context.S0[R_ shr 24] + Context.S1[(R_ shr 16) and $FF]) xor
    Context.S2[(R_ shr 8) and $FF] + Context.S3[R_ and $FF]);
...
procedure InitializeSP(var Context : TSBBlowfishContext);
var
  J : integer;
begin
  ...
  for J := 0 to 255 do
  begin
    Context.S0[J] := ORIG_S[0, J];
    Context.S1[J] := ORIG_S[1, J];
    Context.S2[J] := ORIG_S[2, J];
    Context.S3[J] := ORIG_S[3, J];
  end;
  ...
  Context.P8 := ORIG_P[8];
  Context.P9 := ORIG_P[9];
  Context.P10 := ORIG_P[10];
  Context.P11 := ORIG_P[11];
  Context.P12 := ORIG_P[12];
  Context.P13 := ORIG_P[13];
  Context.P14 := ORIG_P[14];
  Context.P15 := ORIG_P[15];
  Context.P16 := ORIG_P[16];
  Context.P17 := ORIG_P[17];
end;

procedure SeedKeyData(var Context : TSBBlowfishContext; const Key : ByteArray);
var
  I, J, K : integer;
  ExKey : ByteArray;
begin

  { we need 72 = 18 * 4 bytes of cycled key data }
  
  I := Length(Key);
  J := (72 + I - 1) div I;
  SetLength(ExKey, I * J);
  for K := 0 to J - 1 do
    SBMove(Key[0], ExKey[I * K], I);

  { initializing P with cycled key }
  
  Context.P0  := Context.P0  xor ((ExKey[0]  shl 24) or (ExKey[1]  shl 16) or (ExKey[2]  shl 8) or ExKey[3]);
  Context.P1  := Context.P1  xor ((ExKey[4]  shl 24) or (ExKey[5]  shl 16) or (ExKey[6]  shl 8) or ExKey[7]);
  Context.P2  := Context.P2  xor ((ExKey[8]  shl 24) or (ExKey[9]  shl 16) or (ExKey[10] shl 8) or ExKey[11]);
  Context.P3  := Context.P3  xor ((ExKey[12] shl 24) or (ExKey[13] shl 16) or (ExKey[14] shl 8) or ExKey[15]);
  Context.P4  := Context.P4  xor ((ExKey[16] shl 24) or (ExKey[17] shl 16) or (ExKey[18] shl 8) or ExKey[19]);
  Context.P5  := Context.P5  xor ((ExKey[20] shl 24) or (ExKey[21] shl 16) or (ExKey[22] shl 8) or ExKey[23]);
  Context.P6  := Context.P6  xor ((ExKey[24] shl 24) or (ExKey[25] shl 16) or (ExKey[26] shl 8) or ExKey[27]);
  Context.P7  := Context.P7  xor ((ExKey[28] shl 24) or (ExKey[29] shl 16) or (ExKey[30] shl 8) or ExKey[31]);
  Context.P8  := Context.P8  xor ((ExKey[32] shl 24) or (ExKey[33] shl 16) or (ExKey[34] shl 8) or ExKey[35]);
  Context.P9  := Context.P9  xor ((ExKey[36] shl 24) or (ExKey[37] shl 16) or (ExKey[38] shl 8) or ExKey[39]);
  Context.P10 := Context.P10 xor ((ExKey[40] shl 24) or (ExKey[41] shl 16) or (ExKey[42] shl 8) or ExKey[43]);
  Context.P11 := Context.P11 xor ((ExKey[44] shl 24) or (ExKey[45] shl 16) or (ExKey[46] shl 8) or ExKey[47]);
  Context.P12 := Context.P12 xor ((ExKey[48] shl 24) or (ExKey[49] shl 16) or (ExKey[50] shl 8) or ExKey[51]);
  Context.P13 := Context.P13 xor ((ExKey[52] shl 24) or (ExKey[53] shl 16) or (ExKey[54] shl 8) or ExKey[55]);
  Context.P14 := Context.P14 xor ((ExKey[56] shl 24) or (ExKey[57] shl 16) or (ExKey[58] shl 8) or ExKey[59]);
  Context.P15 := Context.P15 xor ((ExKey[60] shl 24) or (ExKey[61] shl 16) or (ExKey[62] shl 8) or ExKey[63]);
  Context.P16 := Context.P16 xor ((ExKey[64] shl 24) or (ExKey[65] shl 16) or (ExKey[66] shl 8) or ExKey[67]);
  Context.P17 := Context.P17 xor ((ExKey[68] shl 24) or (ExKey[69] shl 16) or (ExKey[70] shl 8) or ExKey[71]);
end;

procedure EncryptSeededContext(var Context : TSBBlowfishContext);
var
  J : integer;
  DataL, DataR : cardinal;
begin
  DataL := 0;
  DataR := 0;

  EncryptBlock(Context, DataL, DataR);
  Context.P0 := DataL;
  Context.P1 := DataR;
  EncryptBlock(Context, DataL, DataR);
  Context.P2 := DataL;
  ...
  begin
    EncryptBlock(Context, DataL, DataR);
    Context.S0[J shl 1] := DataL;
    Context.S0[(J shl 1) + 1] := DataR;
  end;

  for J := 0 to 127 do
  begin
    EncryptBlock(Context, DataL, DataR);
    Context.S1[J shl 1] := DataL;
    Context.S1[(J shl 1) + 1] := DataR;
  end;

  for J := 0 to 127 do
  begin
    EncryptBlock(Context, DataL, DataR);
    Context.S2[J shl 1] := DataL;
    Context.S2[(J shl 1) + 1] := DataR;
  end;

  for J := 0 to 127 do
  begin
    EncryptBlock(Context, DataL, DataR);
    Context.S3[J shl 1] := DataL;
    Context.S3[(J shl 1) + 1] := DataR;
  end;
end;
...
begin
  ...
  SeedKeyData(Context, Key);
  EncryptSeededContext(Context);
end;
...
begin
  ...
  { applying salt encryption step to P and S, assuming salt size is 16 bytes }

  DataL := (Salt[0] shl 24) or (Salt[1] shl 16) or (Salt[2] shl 8) or Salt[3];
  DataR := (Salt[4] shl 24) or (Salt[5] shl 16) or (Salt[6] shl 8) or Salt[7];
  EncryptBlock(Context, DataL, DataR);
  Context.P0 := DataL;
  Context.P1 := DataR;
  DataL := DataL xor ((Salt[8] shl 24) or (Salt[9] shl 16) or (Salt[10] shl 8) or Salt[11]);
  DataR := DataR xor ((Salt[12] shl 24) or (Salt[13] shl 16) or (Salt[14] shl 8) or Salt[15]);
  EncryptBlock(Context, DataL, DataR);
  Context.P2 := DataL;
  Context.P3 := DataR;
  DataL := DataL xor ((Salt[0] shl 24) or (Salt[1] shl 16) or (Salt[2] shl 8) or Salt[3]);
  DataR := DataR xor ((Salt[4] shl 24) or (Salt[5] shl 16) or (Salt[6] shl 8) or Salt[7]);
  EncryptBlock(Context, DataL, DataR);
  Context.P4 := DataL;
  Context.P5 := DataR;
  DataL := DataL xor ((Salt[8] shl 24) or (Salt[9] shl 16) or (Salt[10] shl 8) or Salt[11]);
  ...
  begin
    ...
    EncryptBlock(Context, DataL, DataR);
    Context.S0[J] := DataL;
    Context.S0[J + 1] := DataR;
    DataL := DataL xor ((Salt[0] shl 24) or (Salt[1] shl 16) or (Salt[2] shl 8) or Salt[3]);
    DataR := DataR xor ((Salt[4] shl 24) or (Salt[5] shl 16) or (Salt[6] shl 8) or Salt[7]);
    EncryptBlock(Context, DataL, DataR);
    Context.S0[J + 2] := DataL;
    Context.S0[J + 3] := DataR;
  end;
  { S1 }
  for I := 0 to 63 do
  begin
    ...
    EncryptBlock(Context, DataL, DataR);
    Context.S1[J] := DataL;
    Context.S1[J + 1] := DataR;
    DataL := DataL xor ((Salt[0] shl 24) or (Salt[1] shl 16) or (Salt[2] shl 8) or Salt[3]);
    DataR := DataR xor ((Salt[4] shl 24) or (Salt[5] shl 16) or (Salt[6] shl 8) or Salt[7]);
    EncryptBlock(Context, DataL, DataR);
    Context.S1[J + 2] := DataL;
    Context.S1[J + 3] := DataR;
  end;
  { S2 }
  for I := 0 to 63 do
  begin
    ...
    EncryptBlock(Context, DataL, DataR);
    Context.S2[J] := DataL;
    Context.S2[J + 1] := DataR;
    DataL := DataL xor ((Salt[0] shl 24) or (Salt[1] shl 16) or (Salt[2] shl 8) or Salt[3]);
    DataR := DataR xor ((Salt[4] shl 24) or (Salt[5] shl 16) or (Salt[6] shl 8) or Salt[7]);
    EncryptBlock(Context, DataL, DataR);
    Context.S2[J + 2] := DataL;
    Context.S2[J + 3] := DataR;
  end;
  { S3 }
  for I := 0 to 63 do
  begin
    ...
    EncryptBlock(Context, DataL, DataR);
    Context.S3[J] := DataL;
    Context.S3[J + 1] := DataR;
    DataL := DataL xor ((Salt[0] shl 24) or (Salt[1] shl 16) or (Salt[2] shl 8) or Salt[3]);
    DataR := DataR xor ((Salt[4] shl 24) or (Salt[5] shl 16) or (Salt[6] shl 8) or Salt[7]);
    EncryptBlock(Context, DataL, DataR);
    Context.S3[J + 2] := DataL;
    Context.S3[J + 3] := DataR;
  end;

  { additional seeding with key and salt }
  R := 1 shl Rounds;
